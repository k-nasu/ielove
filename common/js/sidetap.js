...
//��TOP�ɃX�N���[�������邽�߂̋L�q//////////////////////////////////////////////////////////////////////////////////
        $('.pageTop a[href*=#]').click(function () {
            ...
            if (target) {
                ...
                $('.stp-content-body').animate({scrollTop: 0}, '1');
                return false;
            }
        });
//��TOP�ɃX�N���[�������邽�߂̋L�q//////////////////////////////////////////////////////////////////////////////////
...
this.History = {
    ...
    getHistory: function (historyType) {
        ...
        $.ajax({
            type: "POST",
            url: "/common/ajax/gethistoryformobile/",
...
(function() {
    ...
    $(document).ready(function () {
        ...
        $('.close_menu').click(st.toggle_nav);
        $('.more_info_button').click(function () {
            if ($(this).children(".history_type")) {
                // 更新情報を非同期通信で得る
                var type = $(this).children(".history_type").val();
                History.getHistory(type).done(function (re) {
                    $("#info").html(re);
                }).fail(function () {
        ...
        $('.info').click(function () {
            $(".stp-content-panel").addClass('hidden');
            $("#about").removeClass('hidden');
            $('html,body').animate({scrollTop: 0}, 'fast');
            $(".station_refine").addClass('none');
            $(".except_station").removeClass('none');
            /*
        ...
        $('.info_station').click(function () {
            $(".stp-content-panel").addClass('hidden');
            $("#about").removeClass('hidden');
            $('html,body').animate({scrollTop: 0}, 'fast');
            $(".station_refine").removeClass('none');
            $(".except_station").addClass('none');
            /*
          return st.show_section(about, {
            animation: 'upfrombottom'
          });
        ...
        $('#about a.cancel').click(function () {
            $(".stp-content-panel").addClass('hidden');
            $("#defaultContents").removeClass('hidden');
            /*
            return st.show_section(defaultContents, {
...
function slideEffect () {// 今までのスライド記述。失敗でも成功でも稼働
    $(".stp-content-panel").addClass('hidden');
    $("#about").removeClass('hidden');
    $('html,body').animate({scrollTop: 0}, 'fast');
}